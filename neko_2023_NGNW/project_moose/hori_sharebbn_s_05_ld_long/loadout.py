# Anchor goes here.
from neko_2023_NGNW.project_hydra.configs.training_profiles.anchor_setup_main import one_hori_s_novert                 as anchor_setup
########## Protocol goes here.
...
method_name="horizontal_only_1_horizontal_short_05"