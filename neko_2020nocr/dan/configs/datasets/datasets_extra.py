...
def get_dataset_testC(maxT,root,dict_dir):
    return {
...
def get_dataset_testCXL(maxT,root,dict_dir):
    return {
...
def get_std_uncased_dsQA(maxT=25,root="/home/lasercat/ssddata/",dict_dir='../../dict/dic_36.txt'):
    return {
        'dataset_train': lmdbDataset,
        'dataset_train_args': {
            'roots': [get_nips14(root),get_cvpr16(root)],
...
def get_std_uncased_dsCQAXL(maxT=25,root="/home/lasercat/ssddata/",dict_dir='../../dict/dic_36.txt'):
    return {
        'dataset_train': colored_lmdbDataset,
        'dataset_train_args': {
            'roots': [get_nips14(root),get_cvpr16(root)],
...
def get_cute_uncased_ds(maxT=25,root="/home/lasercat/ssddata/",dict_dir='../../dict/dic_36.txt'):
    return {
        "dict_dir":dict_dir,
        "case_sensitive": False,
        "te_case_sensitive": False,
...
def get_std_uncased_dsXXL(maxT=25,root="/home/lasercat/ssddata/",dict_dir='../../dict/dic_36.txt'):
    return {
        'dataset_train': lmdbDataset,
        'dataset_train_args': {
            'roots': [get_nips14(root),get_cvpr16(root)],
...
def get_test_all_uncased_dsrgb(maxT=25,root="/home/lasercat/ssddata/",dict_dir='../../dict/dic_36.txt'):
    return {
        "dict_dir":dict_dir,
        "case_sensitive": False,
        "te_case_sensitive": False,
        "datasets":{
        "SVTP": get_dataset_testC(maxT, get_SVTP(root), dict_dir),
        "CUTE": get_dataset_testC(maxT, get_cute(root), dict_dir),
        "IIIT5k": get_dataset_testC(maxT, get_iiit5k(root), dict_dir),
        "SVT": get_dataset_testC(maxT, get_SVT(root), dict_dir),
        "IC03": get_dataset_testC(maxT, get_IC03_867(root), dict_dir),
        "IC13": get_dataset_testC(maxT, get_IC13_1015(root), dict_dir),
        }
            }
...
def get_test_all_uncased_dsCXL(maxT=25,root="/home/lasercat/ssddata/",dict_dir='../../dict/dic_36.txt'):
    return {
        "dict_dir":dict_dir,
        "case_sensitive": False,
        "te_case_sensitive": False,
        ...
        "datasets":{
        "SVTP": get_dataset_testCXL(maxT, get_SVTP(root), dict_dir),
        "CUTE": get_dataset_testCXL(maxT, get_cute(root), dict_dir),
        "IIIT5k": get_dataset_testCXL(maxT, get_iiit5k(root), dict_dir),
        "SVT": get_dataset_testCXL(maxT, get_SVT(root), dict_dir),
        "IC03": get_dataset_testCXL(maxT, get_IC03_867(root), dict_dir),
        "IC13": get_dataset_testCXL(maxT, get_IC13_1015(root), dict_dir),
        }
            }
...
def get_jpn(maxT,dict_dir=None,root="/home/lasercat/ssddata/"):
    return {
        'dataset_train': lmdbDataset_repeat,
        'dataset_train_args': {
            "repeat": 16,
